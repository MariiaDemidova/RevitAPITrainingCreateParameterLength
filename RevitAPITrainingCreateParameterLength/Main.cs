...
namespace RevitAPITrainingCreateParameterLength
{
    ...
    public class Main : IExternalCommand
    {
        ...
        private void CreateSharedParameter(Application application, Document doc, string parameterName, CategorySet categorySet, BuiltInParameterGroup builtInParameterGroup, bool isInstance)
        {
            ...
            Definition definition = defFile.Groups.SelectMany(group => group.Definitions).FirstOrDefault(def => def.Equals(parameterName));
            if (definition == null)
            {
